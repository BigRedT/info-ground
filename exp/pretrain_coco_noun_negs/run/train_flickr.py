...
from ..train_flickr import main as train_flickr
...
def main(**kwargs):
    ...
    exp_const.model_save_step = 150000//(2*kwargs['train_batch_size']) # 4000=400000/(2*50)
    val_freq_factor=2
    ...
    train_flickr(exp_const,data_const,model_const)
